...
const getVrioCampaignInfoBasedOnPaymentMethod = (isVipUpsell) => {
    const vrioCampaigns = [{"_id":"69fbefde9099275155853af1","integration":[{"_id":"68de8b4ba7998abc5f77b02a","workspace":"develop","platform":"vrio","description":"production","fields":{"publicApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg","internalApiKey":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6ImFkbWluIiwib3JnYW5pemF0aW9uIjoibXZtdC52cmlvIiwiaWQiOiJhZTE4OGY0ZC0yMDAwLTQ4ZWItOGE4YS03OGY1ZjBiMWQxZGMiLCJpYXQiOjE3NTU3MjQ1OTIsImF1ZCI6InVybjp2cmlvOmFwaTp1c2VyIiwiaXNzIjoidXJuOnZyaW86YXBpOmF1dGhlbnRpY2F0b3IiLCJzdWIiOiJ1cm46dnJpbzphcGk6MjIifQ.51xFtExTqVm3o2mhizx3VsiSTv7pNAB6beF1rmV_-Jg"},"status":"active","createdAt":1758437407128,"updatedAt":1759415115447,"__v":0,"category":"CRM","id":"68de8b4ba7998abc5f77b02a"}],"externalId":"312","name":"Akemi Detox Tea - Network - (1) - Australia","currency":"AUD","countries":[13],"metadata":{"campaign_id":312,"campaign_name":"","payment_type_id":1,"campaign_active":true,"campaign_prepaid":true,"campaign_payment_method_required":true,"campaign_group_transactions":true,"campaign_global_js":"","campaign_global_seo_title":"","campaign_global_seo_keywords":"","campaign_global_seo_description":"","date_created":"2026-05-07 01:50:22","created_by":0,"date_modified":"2026-05-07 01:50:22","modified_by":0,"campaign_notes":"","offers":[],"shipping_profiles":[],"campaignId":"312","externalId":312,"description":"","payment_methods":["amex","discover","visa","master"],"alternative_payments":[],"countries":[{"iso_numeric":36,"calling_code":"61","id":13,"name":"Australia","iso_2":"AU","iso_3":"AUS"}]},"funnels":[],"createdAt":1778090535327,"updatedAt":1778118622902,"packages":[],"status":"active","platform":"vrio","__v":0,"id":"69fbefde9099275155853af1"}];
...
const i18n = {
  ...
  "validation": {
    ...
    "stateRequired": "* State/Territory is required",
  ...
  "labels": {
    "noStatesAvailable": "No States or Territories Available for this Country",
...
const UPSELL_NEXT_PAGE_SLUG = "4/order/en/au/thank-you";

function getNextPageSlugForRedirect() {
  const normalize = (value) => {
    if (!value) return "";
    return value.startsWith("/69fbf0149099275155853b00-preview") ? value : (value.startsWith("/") ? "/69fbf0149099275155853b00-preview" + value : "/69fbf0149099275155853b00-preview/" + value);
  };
...
const getVrioOfferIdByProductId = (productId) => {
    const vrioOffers = [{"id":326,"offerTypeId":2,"name":"Akemi Detox Tea - VIP - Australia","items":[{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":0,"shippable":false}]},{"id":325,"offerTypeId":1,"name":"Akemi Detox Tea - Network - Australia","items":[{"name":"1x Pack of Detox Tea (28 Bags)","id":1749,"quantity":1,"price":0,"shippable":false},{"name":"2x Pack of Detox Tea (56 Bags)","id":1746,"quantity":1,"price":0,"shippable":false},{"name":"3x Pack of Detox Tea (84 Bags)","id":1747,"quantity":1,"price":0,"shippable":false},{"name":"Akemi Detox Tea","id":1698,"quantity":1,"price":0,"shippable":true},{"name":"Akemi Detox Tea  Journey Package Protection","id":1703,"quantity":1,"price":0,"shippable":false},{"name":"Akemi Detox Tea - 3 Year Warranty","id":1702,"quantity":1,"price":0,"shippable":false},{"name":"Special 1x EXTRA Akemi Detox Tea","id":1704,"quantity":1,"price":0,"shippable":false},{"name":"Special 1x EXTRA Akemi Detox Tea","id":1719,"quantity":1,"price":0,"shippable":false}]}];
    ...
    const response = await fetch(
      `https://app-cms-api-proxy-prod-001.azurewebsites.net/vrio/order_offers`,
      {
        ...
        body: JSON.stringify({
          ...
          order_id: lastOrderId,
          pageId: "lsSPSbT0JywgGqypChjuya9YTiPDwkd1hRsXFT36f-lyP3toN8YsuGWLwwDOV3jT"
        })
      }
    );
...
const processUpsell = async () => {
  ...
  try {
    const orderData = JSON.parse(sessionStorage.getItem("orderData"));
    orderData.pageId = "lsSPSbT0JywgGqypChjuya9YTiPDwkd1hRsXFT36f-lyP3toN8YsuGWLwwDOV3jT";
    const lastOrderId = sessionStorage.getItem("cms_oid");
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "ADT-AUS-Downsell-V1", pageType: "Upsell" },
    };
